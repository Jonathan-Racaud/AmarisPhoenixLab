defmodule AmarisPhoenixLabWeb.ProjectLiveTest do
  ...
  @create_attrs %{description: "some description", is_deleted: "some is_deleted", name: "some name"}
  ...
  defp fixture(:project) do
    {:ok, project} = CMS.create_project(@create_attrs)
    project
  end

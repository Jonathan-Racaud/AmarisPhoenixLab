defmodule AmarisPhoenixLabWeb.UserLiveTest do
  ...
  @create_attrs %{email: "some email", is_deleted: true, name: "some name", password_hash: "some password_hash"}
  @update_attrs %{email: "some updated email", is_deleted: false, name: "some updated name", password_hash: "some updated password_hash"}
  @invalid_attrs %{email: nil, is_deleted: nil, name: nil, password_hash: nil}
